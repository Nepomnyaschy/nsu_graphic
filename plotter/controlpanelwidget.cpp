    ...
    QWidget(parent)
{
    ...
    spinbox1->setMinimum(-300);
    label1 = new QLabel();

    slider2 = new QSlider(Qt::Horizontal);
    slider2->setMinimum(-300);
    slider2->setMaximum(300);
    spinbox2 = new QSpinBox();
    spinbox2->setMaximum(300);
    spinbox2->setMinimum(-300);
    label2 = new QLabel();

    slider3 = new QSlider(Qt::Horizontal);
    slider3->setMinimum(-300);
    slider3->setMaximum(300);
    spinbox3 = new QSpinBox();
    spinbox3->setMaximum(300);
    spinbox3->setMinimum(-300);
    label3 = new QLabel();
